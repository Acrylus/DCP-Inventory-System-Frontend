        ...
        <table className="w-full border-collapse text-left bg-white">
          <thead>
            <tr className="bg-gray-100 text-gray-700">
              <th className="px-4 py-3 border border-gray-200">Division</th>
              <th className="px-4 py-3 border border-gray-200">District</th>
              <th className="px-4 py-3 border border-gray-200">School</th>
              <th className="px-4 py-3 border border-gray-200">Batch No</th>
              <th className="px-4 py-3 border border-gray-200">
                Delivery Date
              </th>
              <th className="px-4 py-3 border border-gray-200">Item</th>
              <th className="px-4 py-3 border border-gray-200">
                Serial Number
              </th>
            </tr>
