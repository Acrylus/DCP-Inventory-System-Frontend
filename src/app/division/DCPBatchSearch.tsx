...
const DCPBatchSearch = () => {
  ...
  const fetchSchoolBatchList = async (batchId?: number) => {
    ...
    try {
      ...
      console.log(`Fetched school batch list for batch ${batchId}:`, data);
      ...
      <div className="flex gap-4 h-full">
        ...
        <div className="w-2/3 border rounded-lg p-4 overflow-auto">
          <h2 className="text-lg font-bold mb-3">
            School Details {selectedBatch && `for ${selectedBatch.batchName}`}
          </h2>
          <div className="overflow-auto">
            <table className="w-full border-collapse border border-slate-200">
              <thead>
              ...
              <tbody>
                {loading ? (
                  ...
                  schoolBatchList.map((sbl) => (
                    ...
                    >
                      <td className="px-4 py-2 border border-slate-300">
                        {sbl.school?.district.division?.division || "N/A"}
                      </td>
                      <td className="px-4 py-2 border border-slate-300">
                        {sbl.school?.district?.name || "N/A"}
                      </td>
                      <td className="px-4 py-2 border border-slate-300">
                        {sbl.school?.classification || "N/A"}
                      </td>
                      <td className="px-4 py-2 border border-slate-300">
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-30 backdrop-blur-sm">
          <div className="bg-white p-6 rounded-xl shadow-xl w-full max-w-3xl">
            ...
            <div className="grid grid-cols-3 gap-4 mt-2">
              ...
              <div>
                ...
                <input
                  type="text"
                  value={
                    selectedSchoolBatchList.school.district.division.division ||
                    ""
                  }
              ...
              <div>
                ...
                <input
                  type="text"
                  value={selectedSchoolBatchList?.school?.district?.name || ""}
                  className="w-full p-2 border border-gray-300 rounded-md bg-gray-200"
                  disabled
                />
              </div>
              ...
              <div>
                ...
                <select
                  value={selectedSchoolBatchList?.school?.schoolRecordId || ""}
                  onChange={(e: React.ChangeEvent<HTMLSelectElement>) =>
                    handleSchoolChange(Number(e.target.value))
                  }
              ...
              <div>
                ...
                <select
                  value={selectedSchoolBatchList?.batch?.batchId || ""}
              ...
              <div>
                ...
                <input
                  type="date"
                  value={selectedSchoolBatchList?.deliveryDate || ""}
                  onChange={(e) =>
                    handleDeliveryDateChange(Number(e.target.value))
                  }
              ...
              <div>
                ...
                <input
                  type="number"
                  value={selectedSchoolBatchList?.numberOfPackage || ""}
              ...
              <div>
                ...
                <input
                  type="text"
                  value={selectedSchoolBatchList?.remarks || ""}
            ...
            <div className="mt-6 flex justify-end space-x-4">
              <button
                className="px-5 py-2 bg-blue-500 text-white font-medium rounded-lg hover:bg-blue-600 transition mt-4 flex"
